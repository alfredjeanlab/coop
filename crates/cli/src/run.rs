...
/// Channel capacity for the input (keyboard/API -> PTY) MPSC channel.
pub const INPUT_CHANNEL_CAPACITY: usize = 256;
/// Broadcast capacity for raw PTY output events.
pub const OUTPUT_BROADCAST_CAPACITY: usize = 256;
/// Broadcast capacity for agent state-change events.
pub const STATE_BROADCAST_CAPACITY: usize = 64;
/// Broadcast capacity for prompt (permission/plan) events.
pub const PROMPT_BROADCAST_CAPACITY: usize = 64;
