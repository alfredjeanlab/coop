...
/// Channel capacity for the input (keystrokes → session) mpsc channel.
pub(crate) const INPUT_CHANNEL_CAPACITY: usize = 256;
/// Channel capacity for the output (PTY data → subscribers) broadcast channel.
pub(crate) const OUTPUT_CHANNEL_CAPACITY: usize = 256;
/// Channel capacity for the state-change broadcast channel.
pub(crate) const STATE_CHANNEL_CAPACITY: usize = 64;
/// Channel capacity for the prompt-action broadcast channel.
