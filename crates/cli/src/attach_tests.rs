...
async fn run_statusline_cmd_captures_output() {
    let state = AttachState::new(crate::screen::FALLBACK_COLS, crate::screen::FALLBACK_ROWS);
...
async fn run_statusline_cmd_expands_state() {
    let mut state = AttachState::new(crate::screen::FALLBACK_COLS, crate::screen::FALLBACK_ROWS);
...
mod ws_integration {
    ...
    async fn spawn_test_server(
        ...
        let (state, _input_rx) =
            AppStateBuilder::new().ring_size(crate::ring::TEST_RING_SIZE).build();
