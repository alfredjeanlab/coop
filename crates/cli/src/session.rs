...
use crate::{IO_CHANNEL_CAPACITY, SIGNAL_CHANNEL_CAPACITY};
...
/// Maximum number of screen-poll attempts when enriching prompt options.
const ENRICH_MAX_ATTEMPTS: u32 = 10;

/// Delay between screen-poll attempts when enriching prompt options.
